...
begin
  ...
  begin
    if Dados.CdsTerminal.Active then
    begin
      dados.CdsTerminal.Refresh;
      dados.cdsTerminal.Locate('nome', dados.nometerminal, []);
    end;
    ...
    ACBrPosPrinter1.ColunasFonteNormal  := StrToIntDef(dados.qryTerminalCOLUNAS.AsString, 42);
    ACBrPosPrinter1.LinhasEntreCupons   := StrToIntDef(dados.qryTerminalLINHAS_ENTRE_CUPOM.AsString, 5);
    ACBrPosPrinter1.EspacoEntreLinhas   := StrToIntDef(dados.qryTerminalESPACO_ENTRE_LINHAS.AsString, 0);

    ACBrPosPrinter1.ConfigLogo.KeyCode1 := StrToIntDef(dados.qryTerminalL1.AsString, 32);
    ACBrPosPrinter1.ConfigLogo.KeyCode2 := StrToIntDef(dados.qryTerminalL2.AsString, 32);
    ACBrPosPrinter1.ConfigLogo.FatorX   := StrToIntDef(dados.qryTerminalL3.AsString, 1);
    ACBrPosPrinter1.ConfigLogo.FatorY   := StrToIntDef(dados.qryTerminalL4.AsString, 1);
