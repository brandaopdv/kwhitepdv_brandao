...
uses
  ...
  FireDAC.Stan.Option, ShellApi, Messages, Vcl.Consts, System.Variants,
  ...
  Vcl.Themes, ACBrSATClass, WinSock,Psapi, System.MaskUtils, System.Hash,
  ...
  Datasnap.Provider, Datasnap.DBClient, Midaslib, ACBrBase, ACBrSocket, ACBrIBGE,
  IdIPAddrMon, frxRes, FireDAC.Stan.StorageJSON, IdIOHandler, IdIOHandlerSocket,
  IdIOHandlerStack, IdSSL, IdSSLOpenSSL, IdMessage, IdMessageClient, IdSMTPBase,
  IdSMTP, Registry;
...
type
  ...
  TDados = class(TDataModule)
    ...
    DtStPrvdLicenca: TDataSetProvider;
    CdsLicencaCOD_LICENCA: TIntegerField;
    CdsLicencaDESCRICAO: TStringField;
    CdsLicencaURL: TStringField;
    CdsLicencaVIGENTE: TStringField;
    CdsTerminal: TClientDataSet;
    DtStPrvdTerminal: TDataSetProvider;
    CdsTerminalIP: TStringField;
    CdsTerminalNOME: TStringField;
    CdsTerminalIMPRIME: TStringField;
    CdsTerminalUSAGAVETA: TStringField;
    CdsTerminalFABIMPRESSORA: TStringField;
    CdsTerminalMODELO: TStringField;
    CdsTerminalPORTA: TStringField;
    CdsTerminalCONTINGENCIA: TStringField;
    CdsTerminalNVIAS: TSmallintField;
    CdsTerminalSERIE: TStringField;
    CdsTerminalNUMERACAO_INICIAL: TIntegerField;
    CdsTerminalEMPRESA: TIntegerField;
    CdsTerminalVELOCIDADE: TIntegerField;
    CdsTerminalIMPRIME_FECHAMENTO: TStringField;
    CdsTerminalLOGADO: TStringField;
    CdsTerminalEH_CAIXA: TStringField;
    CdsTerminalVERSAO: TSmallintField;
    CdsTerminalTIPO_BROWSER: TStringField;
    CdsTerminalBALANCA_PORTA: TStringField;
    CdsTerminalBALANCA_VELOCIDADE: TStringField;
    CdsTerminalBALANCA_MARCA: TStringField;
    CdsTerminalBALANCA_PARIDADE: TStringField;
    CdsTerminalBALANCA_DATABITS: TStringField;
    CdsTerminalBALANCA_STOPBITS: TStringField;
    CdsTerminalBALANCA_HANDSHAKING: TStringField;
    CdsTerminalDATA_VERSAO: TSQLTimeStampField;
    CdsTerminalDESTINO_IMPRESSAO: TStringField;
    CdsTerminalDT_VERSAO: TStringField;
    CdsTerminalESC_POS_DIRETO: TStringField;
    CdsTerminalPAGINA_CODIGO: TStringField;
    CdsTerminalDATA_SISTEMA: TDateField;
    CdsTerminalIMPRIME_DUAS_LINHAS: TStringField;
    CdsTerminalMARGEM_DIREITA: TFMTBCDField;
    CdsTerminalMARGEM_ESQUERDA: TFMTBCDField;
    CdsTerminalMARGEM_INFERIOR: TFMTBCDField;
    CdsTerminalMARGEM_SUPERIOR: TFMTBCDField;
    CdsTerminalLARGURA_BOBINA: TIntegerField;
    CdsTerminalESPACO_ENTRE_LINHAS: TStringField;
    CdsTerminalLINHAS_ENTRE_CUPOM: TStringField;
    CdsTerminalDT_ULTIMA_ATUALIZACAO: TSQLTimeStampField;
    CdsTerminalTAMANHO_FONTE: TIntegerField;
    CdsTerminalFLAG: TStringField;
    CdsTerminalEXIBE_F3: TStringField;
    CdsTerminalEXIBE_F4: TStringField;
    CdsTerminalEXIBE_F5: TStringField;
    CdsTerminalEXIBE_F6: TStringField;
    CdsTerminalFRENTE: TStringField;
    CdsTerminalRETAGUARDA: TStringField;
    CdsTerminalCAMINHO_SAT_DLL: TStringField;
    CdsTerminalMODELO_SAT_DLL: TStringField;
    CdsTerminalTIPO_SAT_DLL: TStringField;
    CdsTerminalPARAMETROS_ADICIONAIS: TStringField;
    CdsTerminalQRCODE_LATERAL: TStringField;
    CdsTerminalCOLUNAS: TIntegerField;
    CdsTerminalL1: TIntegerField;
    CdsTerminalL2: TIntegerField;
    CdsTerminalL3: TIntegerField;
    CdsTerminalL4: TIntegerField;
    CdsTerminalTIPOIMPRESSORA: TStringField;
    CdsTerminalDATA_SCRIPT: TSQLTimeStampField;
    CdsTerminalEMPRESA_ATIVA: TIntegerField;
    CdsTerminalTEF_LOG: TStringField;
    CdsTerminalTEF_GERENCIADOR: TIntegerField;
    CdsTerminalTEF_MAX_CARTOES: TIntegerField;
    CdsTerminalTEF_TROCO_MAXIMO: TSingleField;
    CdsTerminalTEF_SOFT_HOUSE: TStringField;
    CdsTerminalTEF_REGISTRO: TStringField;
    CdsTerminalTEF_APLICACAO: TStringField;
    CdsTerminalTEF_VERSAO: TStringField;
    CdsTerminalTEF_VIA_REDUZIDA: TStringField;
    CdsTerminalTEF_SUPORTA_DESCONTO: TStringField;
    CdsTerminalTEF_SUPORTA_SAQUE: TStringField;
    CdsTerminalTEF_REAJUSTA_VALOR: TStringField;
    CdsTerminalTEF_MULTIPLO_CARTOES: TStringField;
    CdsTerminalRESTAURANTE: TStringField;
    CdsTerminalDELIVERY: TStringField;
    CdsTerminalPDV: TStringField;
    CdsTerminalCAMINHO_BAR: TStringField;
    CdsTerminalCAMINHO_COZINHA: TStringField;
    CdsTerminalUSA_POS: TStringField;
    CdsTerminalUSA_TEF: TStringField;
    CdsTerminalNUMERO_LOJA: TIntegerField;
    CdsTerminalUSAR_NUMERO_INICIAL: TStringField;
    qryLicencaAtiva: TFDQuery;
    DtStPrvdLicencaAtiva: TDataSetProvider;
    CdsLicencaAtiva: TClientDataSet;
    CdsLicencaAtivaCHAVE: TStringField;
    CdsLicencaAtivaCONTRACHAVE: TStringField;
    QryLogTerminal: TFDQuery;
    ...
    qryTerminalUTILIZA_BALANCA: TStringField;
    CdsTerminalMODELO_TEF: TIntegerField;
    CdsTerminalIP_SERVIDOR_TEF: TStringField;
    CdsTerminalNUMERO_LOGICO_TERMINAL: TIntegerField;
    CdsTerminalPORTA_PIN_PAD: TIntegerField;
    CdsTerminalMENSAGEM_PIN_PAD: TStringField;
    CdsTerminalUTILIZA_BALANCA: TStringField;
    qryParametroDATA_ATUALIZACAO: TSQLTimeStampField;
    qryParametroURL_SUPORTE: TStringField;
    qryParametroDATA_D: TStringField;
    DtStPrvParametro: TDataSetProvider;
    CdsParametro: TClientDataSet;
    CdsParametroVERSAO: TIntegerField;
    CdsParametroDATA_SCRIPT: TDateField;
    CdsParametroEMAIL_SUPORTE: TStringField;
    CdsParametroTITULO_SISTEMA: TStringField;
    CdsParametroSUB_TITULO_SISTEMA: TStringField;
    CdsParametroSITE: TStringField;
    CdsParametroFONE1: TStringField;
    CdsParametroFONE2: TStringField;
    CdsParametroCONTATO: TStringField;
    CdsParametroESTILO: TStringField;
    CdsParametroLINK_TREINAMENTO: TStringField;
    CdsParametroICONE: TBlobField;
    CdsParametroSPLASH: TBlobField;
    CdsParametroSERVIDOR_APP: TStringField;
    CdsParametroUSUARIO_APP: TStringField;
    CdsParametroSENHA_APP: TStringField;
    CdsParametroDATABASE_APP: TStringField;
    CdsParametroDATABASE_LI: TStringField;
    CdsParametroTELA_FUNDO: TStringField;
    CdsParametroMENU_MAXIMIZADO: TStringField;
    CdsParametroSENHA_LI: TStringField;
    CdsParametroTELA_ABERTURA: TStringField;
    CdsParametroTELA_FUNDO_ECF: TStringField;
    CdsParametroUSUARIO_LI: TStringField;
    CdsParametroFTP_PASTA: TStringField;
    CdsParametroFTP_SERVIDOR: TStringField;
    CdsParametroFTP_USUARIO: TStringField;
    CdsParametroFTP_SENHA: TStringField;
    CdsParametroFTP_ARQUIVO: TStringField;
    CdsParametroEMPRESA: TStringField;
    CdsParametroLINK_VENDA: TStringField;
    CdsParametroCAMINHO_LOGO_FPG: TStringField;
    CdsParametroTELA_FUNDO_LOGIN: TStringField;
    CdsParametroCNPJ: TStringField;
    CdsParametroBLOQUEAR_PERSONALIZACAO: TStringField;
    CdsParametroDATA_ATUALIZACAO: TSQLTimeStampField;
    CdsParametroURL_SUPORTE: TStringField;
    CdsParametroDATA_D: TStringField;
    ...
    qryEmpresaOBSERVACAO_VENDA: TMemoField;
    qryParametroTOKEN_GATEWAY: TStringField;
    qryParametroURL_PRODUTOS: TStringField;
    qryParametroURL_PEDIDOS: TStringField;
    ACBrIBGE1: TACBrIBGE;
    qryUF: TFDQuery;
    qryUFUF: TStringField;
    qryBuscaCidade: TFDQuery;
    CdsCidade: TClientDataSet;
    DtStPrvdCidade: TDataSetProvider;
    ...
    qryUpdateDatabase: TFDQuery;
    qryCheckVersion: TFDQuery;
    qryCheckVersionVERSAO: TIntegerField;
    CdsLicencaAtivaNUM_ORDER: TStringField;
    QryLogTerminalMAC_ADDR: TStringField;
    QryLogTerminalIPV4_ADDR: TStringField;
    QryLogTerminalLOGIN_DATA: TDateField;
    QryLogTerminalLOGIN_HORA: TTimeField;
    QryLogTerminalLOGOUT_DATA: TDateField;
    QryLogTerminalLOGOUT_HORA: TTimeField;
    ...
    QRYNFCE_DFCP: TFMTBCDField;
    qryIBPT: TFDQuery;
    qryIBPTVIGENCIAINICIO: TStringField;
    qryIBPTVIGENCIAFIM: TStringField;
    qryNFCE_MXMSG: TStringField;
    qryConfigCSRT: TStringField;
    qryNFCE_MHASHCSRT: TStringField;
    FDStanStorageJSONLink: TFDStanStorageJSONLink;
    qryFPGUSA_POS: TStringField;
    qryPessoasESTRANGEIRO: TStringField;
    qryConfigIDCSRT: TIntegerField;
    qryBandeira: TFDQuery;
    qryBandeiraCODIGO: TIntegerField;
    qryBandeiraDESCRICAO: TStringField;
    qryProdutosFRACIONADO: TStringField;
    qryProdutosDT_ALTERADO: TDateField;
    qryProdutosID_USUARIO: TIntegerField;
    qryProdutosDIAS_VALIDADE: TIntegerField;
    qryNFCE_MAMBIENTE: TSmallintField;
    qryNFCE_MXMOTIVO: TStringField;
    qryNFCE_MTOTALFCP: TFMTBCDField;
    qryTerminalCFE_VERSAO: TStringField;
    CdsTerminalNUMERO_SERIE_SAT: TStringField;
    qryTerminalNUMERO_SERIE_SAT: TStringField;
    CdsTerminalCFE_VERSAO: TStringField;
    qryProdutosECOMPLEMENTO: TStringField;
    qryNFCE_MNUMERO_SESSAO: TIntegerField;
    qryNFCE_MCDV: TIntegerField;
    qryNFCE_MCUF: TIntegerField;
    qryNFCE_MCSTAT: TIntegerField;
    qryNFCE_MCMSG: TIntegerField;
    qryNFCE_MXJUST: TStringField;
    CdsTerminalBALANCA_TIMEOUT: TIntegerField;
    CdsTerminalBALANCA_INTERVALO: TIntegerField;
    qryTerminalBALANCA_TIMEOUT: TIntegerField;
    qryTerminalBALANCA_INTERVALO: TIntegerField;
    qryNFCE_MDATA_CONT: TDateField;
    qryNFCE_MHORA_CONT: TTimeField;
    qryNFCE_MERROVALIDACAO: TStringField;
    qryNFCE_MFRETE: TFMTBCDField;
    qryEmpresaTAXA_ENTREGA: TFMTBCDField;
    qryIBPTVERSAO: TStringField;
    qryBandeiraCODIGO_FISCAL: TStringField;
    qryCrdenciadora: TFDQuery;
    qryCrdenciadoraCODIGO: TIntegerField;
    qryCrdenciadoraNOME: TStringField;
    qryCrdenciadoraCODIGO_FISCAL: TStringField;
    qryCrdenciadoraCNPJ: TStringField;
    qryTerminalGAVETA_SINAL_INVERTIDO: TStringField;
    CdsTerminalGAVETA_SINAL_INVERTIDO: TStringField;
    qryConversaoUnidade: TFDQuery;
    qryConversaoUnidadeCODIGO: TIntegerField;
    qryConversaoUnidadeCOD_UN_ORIG: TStringField;
    qryConversaoUnidadeCOD_UN_DEST: TStringField;
    qryConversaoUnidadeTIPO: TStringField;
    qryConversaoUnidadeFATOR: TSingleField;
    qryUnidadeN_DECIMAL: TIntegerField;
    ...
    QRYNFCE_DVFRETE: TFMTBCDField;
    qryEmpresaPEDIDO_MINIMO: TFMTBCDField;
    qryEmpresaNT_COMPRA_IMP_CUSTO: TStringField;
    qryNFCe_DUP: TFDQuery;
    IdSMTP1: TIdSMTP;
    IdMessage1: TIdMessage;
    IdSSLIOHandlerSocketOpenSSL1: TIdSSLIOHandlerSocketOpenSSL;
    CdsLicencaAtivaHASH: TStringField;
    CdsLicencaAtivaDT_M: TStringField;
    CdsLicencaAtivaDT_D: TStringField;
    QRYNFCE_DST: TStringField;
    qryCSTE: TFDQuery;
    ...
    procedure qryCompraTTOTALGetText(Sender: TField; var Text: string;
      DisplayText: Boolean);
  ...
  public
    ...
    NTerminais: Integer;
    NMaxTerminais: Boolean; // API planos pagar.me
    VerificouOnlineAPI: Boolean;
    aMenu: String;
    Versao: String;
    aUsuario: String;
    aTag: Integer;
    ...
    vLiberaPessoa, vCancelaLicenca: boolean;
    ...
    EhLicencaAPI: Boolean;
    VersaoLibera: Boolean;
    DiasRestantes: Extended;

    procedure AtualizarSistemaFTP;
    procedure AtualizaCidades;
    procedure VerificaDataTrial;
    procedure AtivaTerminal(Response_IP: Integer = 0);
    procedure DesativaTerminal;
    ...
    procedure CriaTerminal(Response_IP: Integer = 0);
    procedure EstornaFinanceiro(codigo: Integer);
    function Numerador(Tabela, Campo, filtra, where, Valor: String): Integer;
    procedure EstornaEstoque(codigo: Integer; QtdAtual, QtdFiscal: Real; op: Word);
    ...
    function DiasAtraso(DataVencimento, DataAtual: TDate; Carencia: Integer): Extended;
    ...
    function checanfce(codigo: Integer; serie: String): boolean;
    ...
    procedure InsereCaixa(Empresa, IDCR, FKPLANO, FKCONTA, ID_USUARIO: Integer;
      ...
      ENTRADA: Extended);
    procedure AtualizaValidadeSistema(codigo: Integer; CNPJ, Bloqueado: string; Data: TDate);
    ...
    procedure InsereMensagemZap(anexo, fone, Mensagem, MensagemPadrao, Pessoa, Empresa, Origem: String);
    ...
    function GetIpAddr(const HostName: string): string;
    function GetMacAddress: string;
    procedure ValidaChave(ContraSenha: String;var datavalidade,versao:string);
    procedure ValidaDataValidade(var data: string);
    function ValidaVersao(versao: string):Integer;
    procedure ValidaVerificador(Serial,ContraSenha: string);
    function MudaChave(Chave: string): string;
    function GetMacAddr(const IPAddress: string; var ErrCode: DWORD): string;
    function ValidaChaveAtiva:Boolean;
    procedure ServidorBD(var Server: String);
    procedure EnviaErro(sTexto: String);
    function GetVersaoTabForn: Integer;
    // retorno o numero de todos os boletos
    { Public declarations }
   end;
const
  TOTAL_TERMINAIS = 'SELECT * FROM LOG_TERMINAL WHERE LOGOUT_DATA IS NULL';
...
function FormatarMascaraValor(sValor: String): String;
function ObterVersaoSO: String;
function VerificaExeWin(sFileName: string): Boolean;

implementation

{%CLASSGROUP 'Vcl.Controls.TControl'}

uses serial, uDadosWeb, uConexaoBD, autoUpdate, uUpdate, UConfigDatabase;
...
begin
  try
    ...
    qryPermissoes.sql.Add('INSERT INTO PEMISSOES (FKUSUARIO, FKTELA, VISUALIZAR, EXCLUIR, EDITAR, INCLUIR, VISIVEL)');
    qryPermissoes.sql.Add('VALUES ( :FKUSUARIO, :FKTELA, :VISUALIZAR, :EXCLUIR, :EDITAR, :INCLUIR, :VISIVEL);');
    qryPermissoes.ParamByName('FKUSUARIO').AsFloat := Dados.qryUsuariosCODIGO.Value;
...
begin
  ...
  begin
    ...
    begin
      if not(qryPermissoes.locate('FKTELA', qryTelas.FieldByName('CODIGO').Value, [])) then
...
begin
  ...
  Dados.qryUpdate.sql.Text := 'update cbr_remessa set CANCELADA=''S'' where ID_CBR_REMESSA_UUID=:ID';
...
procedure TDados.DesativaTerminal;
begin
  qryLogTerminal.Close;
  QryLogTerminal.SQL.Clear;
  QryLogTerminal.SQL.Add(TOTAL_TERMINAIS);
  QryLogTerminal.SQL.Add(' AND MAC_ADDR = :MAC');
  QryLogTerminal.Params[0].DataType := ftString;
  QryLogTerminal.Params[0].Value    := Trim(nometerminal);
  qryLogTerminal.Open;
  Try
    if qryLogTerminal.RecordCount <> 0 then
    begin
      qryLogTerminal.Edit;
      qryLogTerminalLOGOUT_DATA.Value   := Date;
      qryLogTerminalLOGOUT_HORA.Value   := Time;
      qryLogTerminal.Post;
      //Conexao.CommitRetaining;
      Conexao.Commit;
    end;
  Except
    MessageDlg('Erro ao tentar fazer logoff do terminal',mtWarning,[mbok],0);
  End;
end;
...
begin
  Dados.CdsTerminal.Close;
  Dados.qryTerminal.Params[0].Value := Dados.Getcomputer;
  Dados.CdsTerminal.Open;
  AbreTerminal;

  if Dados.CdsTerminalDELIVERY.Value = 'S' then
  begin
    Dados.FTIpoPDV := 'DELIVERY';
    exit;
  end
  else
    if Dados.CdsTerminalRESTAURANTE.Value = 'S' then
    begin
...
begin
  ...
  Dados.qryConsulta.sql.Add('select coalesce(sum(fpg.taxa),0) as TAXA from forma_pagamento  fpg');
...
begin
  ...
  Dados.qryConsulta.Close;
  Dados.qryConsulta.sql.Clear;
  Dados.qryConsulta.sql.Add('select cr.dtvencimento, cr.valor from creceber cr');
  Dados.qryConsulta.sql.Add('where');
...
function TDados.GetVersaoTabForn: Integer;
var
  sNumeroVersao: string;
  oArquivoINI: TIniFile;
begin
  oArquivoINI := TIniFile.Create(ExtractFilePath(Application.ExeName) + 'fornecedorLocal.ini');
  try
...
begin
  // 23-12-2023 (SMF) - Comentado porque o Gestor não deve gerar estes docs fiscais
  ...
  //if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\CTe\Enviadas') then
  ...
  //if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\CTe\Eventos') then
  //  CreateDir(ExtractFilePath(Application.ExeName) + '\CTe\Eventos');
  //if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\CTe\Inutilizacao') then
  //  CreateDir(ExtractFilePath(Application.ExeName) + '\CTe\Inutilizacao');
  if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\NFe\Inutilizacao') then
  ...
  //if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\MDFe\MDFe') then
  //  CreateDir(ExtractFilePath(Application.ExeName) + '\MDFe\MDFe');
  //if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\MDFe\Evento') then
  //  CreateDir(ExtractFilePath(Application.ExeName) + '\MDFe\Evento');
  //if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\MDFe\Salvar') then
  //  CreateDir(ExtractFilePath(Application.ExeName) + '\MDFe\Salvar');
  //if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\MDFe\PDF') then
  ...
  if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\CFe\Venda') then
    CreateDir(ExtractFilePath(Application.ExeName) + '\CFe\Venda');
  if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\CFe\Cancelamento') then
    CreateDir(ExtractFilePath(Application.ExeName) + '\CFe\Cancelamento');
  if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\CFe\Envio') then
    CreateDir(ExtractFilePath(Application.ExeName) + '\CFe\Envio');
  if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\CFe\Schemas') then
    CreateDir(ExtractFilePath(Application.ExeName) + '\CFe\Schemas');
  if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\CFe\Remessa') then
  ...
  if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\MFe\Entrada') then
    CreateDir(ExtractFilePath(Application.ExeName) + '\MFe\Entrada');
  if not DirectoryExists(ExtractFilePath(Application.ExeName) + '\MFe\Saida') then
...
function TDados.GetIpAddr(const HostName: string): string;
var
  WSAData: TWSAData;
  R: PHostEnt;
  A: TInAddr;
...
function TDados.GetMacAddr(const IPAddress: string; var ErrCode: DWORD): string;
var
...
begin
  Dados.qryConsulta.Close;
  Dados.qryConsulta.sql.Clear;
  Dados.qryConsulta.sql.Add(' update produto_serial set DOC_SAIDA=null, SITUACAO=null, DATA_BAIXA=null where codigo=:codigo');
...
begin
  result := 0;
  Dados.qryConsulta.Close;
  Dados.qryConsulta.sql.Text := 'SELECT CODIGO FROM CIDADE WHERE DESCRICAO=:DESCRI AND UF=:UF';
...
begin
  Result := '';
  Dados.qryConsulta.Close;
  Dados.qryConsulta.sql.Text := 'select email1 from pessoa where codigo=:codigo';
  Dados.qryConsulta.Params[0].Value := codigo;
  Dados.qryConsulta.Open;
  if not Dados.qryConsulta.IsEmpty then
...
begin
  Result := 0;
  Dados.qryExecute.Close;
  Dados.qryExecute.sql.Text := 'SELECT COALESCE(MAX(NUMERO),0) qtd FROM NFE_MASTER WHERE SERIE=:SERIE AND FKEMPRESA=:EMPRESA';
...
begin
  try
    DirDoLog := ExtractFileDir(ParamStr(0)) +'\log';
    ForceDirectories(DirDoLog);
    NomeDoLog := DirDoLog + '\' + 'log'+StringReplace(DateToStr(Date), '/', '', [rfReplaceAll]) + '.txt';
    ...
    try
      Writeln(Arquivo, DateTimeToStr(Now) + ' - ' + sTexto);
    finally
      CloseFile(Arquivo);
    end;
  except
  ...
  // procedure
  // begin
  // //todo: Criar flag para habilitar envio
     //dados.EnviaErro(sTexto); // 20-11-2024 - Mantis: 00832
  // end);
  //vTask.Start;
end;
...
begin
  ...
  begin
    if ((UpperCase(ExtractFileName(FProcessEntry32.szExeFile)) =
      UpperCase(sFileName)) or (UpperCase(FProcessEntry32.szExeFile) =
      UpperCase(sFileName))) then
    begin
      Result := true;
    end;
...
procedure TDados.EnviaErro(sTexto: String);
begin
  try
    IdMessage1.From.Address := IdSMTP1.Username;
    IdMessage1.Body.Clear;
    IdMessage1.Body.Add('<html><body>');
    IdMessage1.Body.Add('<p>Empresa: '+ qryEmpresaFANTASIA.AsString);
    IdMessage1.Body.Add('<p>Razão Social: '+ qryEmpresaRAZAO.AsString);
    IdMessage1.Body.Add('<p>CPF/CNPJ: '+ qryEmpresaCNPJ.AsString);
    IdMessage1.Body.Add('<p>Email: '+ qryEmpresaEMAIL.AsString);
    IdMessage1.Body.Add('<p>Versão: '+ GetBuildInfo(Application.ExeName));
    IdMessage1.Body.Add('<p>Terminal: '+Getcomputer);
    IdMessage1.Body.Add('<p>Usuário: '+Dados.vUsuario);
    IdMessage1.Body.Add('<p>Licença: '+Dados.Versao);
    IdMessage1.Body.Add('<p>Licenciado até: '+Data_Validade);
    IdMessage1.Body.Add('<p>OS: '+ ObterVersaoSO);
    IdMessage1.Body.Add('<hr>');
    IdMessage1.Body.Add('<p></p><br>'+ DateTimeToStr(Now) + ' - ' + sTexto);
    IdMessage1.Body.Add('</body></html>');
    IdMessage1.Recipients.EMailAddresses := 'log@pdvkawwhite.com.br';
//    IdMessage1.Recipients[0].Address := '@gmail.com';
    ...
    // 23-10-2024 - Não gerar erro
    {on e: Exception do
    begin
      GravaLog('Erro -139: ' + E.Message);
    end;}
  end;
end;
...
begin
  ...
  sAux := StringOfChar('0', 11 - Length(sValor)) + sValor;
...
begin
  ...
  if Result = true then
    FMsg := 'Sistema bloqueado!'+#13+'Entre em contato com o suporte técnico';
end;

function TDados.checanfce(codigo: Integer; serie: String): boolean;
begin
  try
    Result := false;
    Dados.qryConsulta.Close;
    Dados.qryConsulta.sql.Text := 'select NUMERO FROM NFCE_MASTER WHERE FK_VENDA=:ID AND SERIE=:SERIE AND SITUACAO<>''G'' AND SITUACAO<>''O''';
    Dados.qryConsulta.Params[0].Value := codigo;
    ...
    on e: Exception do
    begin
      GravaLog('Erro -67: ' + e.Message);
      raise Exception.Create(e.Message);
    end;
  end;
end;

procedure TDados.CriaTerminal(Response_IP:Integer = 0);
var
  UltSerie: Integer;
begin
  UltSerie := 0;
  try
    ...
    // 22-05-2024 - Verificar a última série fiscal criada
    Dados.CdsTerminal.Close;
    Dados.qryTerminal.SQL.Clear;
    Dados.qryTerminal.SQL.Add('select * from VENDAS_TERMINAIS');
    Dados.CdsTerminal.Open;
    Dados.CdsTerminal.Last;
    UltSerie := StrToIntDef(Dados.CdsTerminalSERIE.AsString, 0);

    Dados.CdsTerminal.Close;
    Dados.qryTerminal.SQL.Clear;
    Dados.qryTerminal.SQL.Add('select * from VENDAS_TERMINAIS where NOME = :NOME');
    Dados.qryTerminal.Params[0].Value := Dados.Getcomputer;
    Dados.CdsTerminal.Open;

    if Dados.CdsTerminal.Locate('NOME', Dados.nometerminal, []) then
    begin
      Dados.CdsTerminal.Edit;
      if Response_IP = 0 then
        Dados.CdsTerminalIP.Value := IdIPWatch1.LocalIP
      else
        Dados.CdsTerminalIP.Value := '0.0.0.0';

      if ((Dados.CdsTerminalPDV.AsString = 'N') or (Dados.CdsTerminalPDV.IsNull)) and
         ((Dados.CdsTerminalRESTAURANTE.AsString = 'N') or (Dados.CdsTerminalRESTAURANTE.IsNull)) and
         ((Dados.CdsTerminalDELIVERY.AsString = 'N') or (Dados.CdsTerminalDELIVERY.IsNull)) Then
         Dados.CdsTerminalPDV.Value := 'S';
      if Dados.CdsTerminalEH_CAIXA.asString = 'S' then
      begin
        Dados.CdsTerminalEXIBE_F3.Value := 'S';
        Dados.CdsTerminalEXIBE_F4.Value := 'S';
        Dados.CdsTerminalEXIBE_F5.Value := 'S';
        Dados.CdsTerminalEXIBE_F6.Value := 'S';
      end;

      if Dados.CdsTerminal.FieldByName('RETAGUARDA').IsNull then
      begin
        Dados.CdsTerminal.FieldByName('RETAGUARDA').AsString :=
          copy(ExtractFileName(Application.ExeName), 1,
          pos('.', ExtractFileName(Application.ExeName)) - 1);
      end;

      if Dados.CdsTerminalDATA_SISTEMA.IsNull then
        Dados.CdsTerminalDATA_SISTEMA.AsDateTime := FDataSistema
      else
        if FDataSistema > Dados.CdsTerminalDATA_SISTEMA.AsDateTime then
          Dados.CdsTerminalDATA_SISTEMA.Value := FDataSistema;

      Dados.CdsTerminal.Post;
      Dados.CdsTerminal.ApplyUpdates(0);
    end
    else
    begin
      Dados.CdsTerminal.Insert;
      Dados.CdsTerminalNOME.Value := Dados.nometerminal;
      if Response_IP = 0 then
        Dados.CdsTerminalIP.Value := IdIPWatch1.LocalIP
      else
        Dados.CdsTerminalIP.Value := '0.0.0.0';

      Dados.CdsTerminalIMPRIME.Value   := 'S';
      Dados.CdsTerminalUSAGAVETA.Value := 'N';

      // A série única será representada por zero (NFCe)
      if UltSerie > 0 then
      begin
        Inc(UltSerie);
        Dados.CdsTerminalSERIE.Value := IntToStr(UltSerie);
      end
      else
        Dados.CdsTerminalSERIE.Value := '0'; //1

      Dados.CdsTerminalNVIAS.Value     := 1;
      Dados.CdsTerminalVERSAO.Value    := 1;
      Dados.CdsTerminalCOLUNAS.Value   := 42;
      Dados.CdsTerminalL1.Value        := 32;
      Dados.CdsTerminalL2.Value        := 32;
      Dados.CdsTerminalL3.Value        := 1;
      Dados.cdsTerminalL4.Value        := 1;
      Dados.CdsTerminalNUMERACAO_INICIAL.Value := 1;
      Dados.CdsTerminalTIPOIMPRESSORA.Value    := '2'; // Bobina
      Dados.CdsTerminalMODELO.Value            := 'TEXTO';
      Dados.cdsTerminalPORTA.Value             := '';
      Dados.CdsTerminalVELOCIDADE.AsString     := '115200';
      Dados.CdsTerminalEH_CAIXA.Value          := 'S';
      Dados.CdsTerminalPDV.Value               := 'S';
      Dados.CdsTerminalRESTAURANTE.Value       := 'N';
      Dados.CdsTerminalDELIVERY.Value          := 'N';
      Dados.CdsTerminalEXIBE_F3.Value          := 'S';
      Dados.CdsTerminalEXIBE_F4.Value          := 'S';
      Dados.CdsTerminalEXIBE_F5.Value          := 'S';
      Dados.CdsTerminalEXIBE_F6.Value          := 'S';
      Dados.CdsTerminalDATA_VERSAO.AsDateTime  := now;
      Dados.cdsTerminalDATA_SISTEMA.AsDateTime := FDataSistema;
      Dados.CdsTerminalUTILIZA_BALANCA.Value   := 'N';
//      Dados.CdsTerminalEMPRESA.Value           := qryEmpresaCODIGO.Value;
      Dados.CdsTerminalGAVETA_SINAL_INVERTIDO.Value := 'N';

      // 12-03-2024
      if (Dados.Versao = 'RFIS') then
        Dados.CdsTerminalCFE_VERSAO.Value := '0.08';

      Dados.CdsTerminal.Post;
      Dados.CdsTerminal.ApplyUpdates(-1);
    end;
    //Dados.Conexao.CommitRetaining;
    Conexao.Commit;
    Dados.CdsTerminal.Refresh;
  except
    // faz nada
    on E: Exception do
      GravaLog('Erro -97: ' + E.Message);
  end;
end;
...
begin
  Result := '';
  Dados.qryConsulta.Close;
  Dados.qryConsulta.sql.Text := 'select DESCRICAO from produto where codigo=:codigo';
  Dados.qryConsulta.Params[0].Value := codigo;
  Dados.qryConsulta.Open;
  if not Dados.qryConsulta.IsEmpty then
...
begin
  ...
  Dados.qryConsulta.sql.Text := 'select DESCRICAO from produto where codbarra=:codigo';
  Dados.qryConsulta.Params[0].Value := codigo;
  Dados.qryConsulta.Open;
  if not Dados.qryConsulta.IsEmpty then
    Result := Dados.qryConsulta.FieldByName('DESCRICAO').AsString;
...
procedure TDados.GetOpenProcess(List : TStrings);
const
...
function TDados.WinExecAndWait32(Filename: string; Visibility: Integer): DWORD;
...
begin
  ...
  // 26-12-2023 (SMF) - Initialize output file security attributes
  Security.nLength := SizeOf(TSecurityAttributes);
  Security.bInheritHandle := True;
  Security.lpSecurityDescriptor := nil;

  if not CreateProcess(nil, zAppName, { pointer to command line string } @Security, { pointer to process security attributes } @Security, { pointer to thread security attributes } False,
...
function TDados.RunAsAdmin(hWnd: hWnd; filename: string; Parameters: string; Visible: Boolean = true): Boolean;
{
...
function TDados.DiasAtraso(DataVencimento, DataAtual: TDate; Carencia: Integer): Extended;
Var
  Dias: Integer;
  DataCarencia: TDate;
begin
...
begin
  Result := DiasAtraso(qryCRDTVENCIMENTO.Value, Date, Dados.qryEmpresaCARENCIA_JUROS.Value) * Dados.qryEmpresaJUROS_DIA.AsFloat;
end;
...
procedure TDados.ServidorBD(var Server: String);
begin
  Server := Dados.Conexao.Params.Values['Server'];
  if (UpperCase(Server) = 'LOCALHOST') or (Server = '127.0.0.1') then
    Server := IdIPWatch1.LocalIP;
end;
...
procedure TDados.SetResourceString(AResString: PResStringRec; ANewValue: PChar);
var
  POldProtect: DWORD;
begin
...
procedure TDados.AtivaTerminal(Response_IP: Integer = 0);
var
  TotalTerminais: Integer;
begin
  // Fazer teste no número de terminais licenciados
  QryLogTerminal.SQL.Clear;
  QryLogTerminal.SQL.Add(TOTAL_TERMINAIS);
  qryLogTerminal.Open;

  if NTerminais = 0 then
    NTerminais := 1;

  //GravaLog('Terminais(2): ' + IntToStr(NTerminais));

  TotalTerminais := qryLogTerminal.RecordCount;
  qryLogTerminal.close;
  QryLogTerminal.SQL.Add(' AND MAC_ADDR = :MAC');
  QryLogTerminal.Params[0].DataType := ftString;
  QryLogTerminal.Params[0].Value    := Trim(nometerminal);
  ...
  if (TotalTerminais < NTerminais) Then
  begin
    if qryLogTerminal.RecordCount = 0 then // Faz o teste para verificar sessão deixada aberta em outro acesso
    begin
      qryLogTerminal.Insert;
      qryLogTerminalMAC_ADDR.Value    := Trim(nometerminal);
      if Response_IP = 0  then
        qryLogTerminalIPV4_ADDR.Value   := IdIPWatch1.LocalIP
      else
        qryLogTerminalIPV4_ADDR.Value   := '0.0.0.0';

      qryLogTerminalLOGIN_DATA.Value  := Date;
      qryLogTerminalLOGIN_HORA.Value  := Time;
      qryLogTerminal.Post;
      //Conexao.CommitRetaining;
      Conexao.Commit;
    end;
  ...
  begin
    // 23-01-2025: Valida licença Kiwify
    //if qryLogTerminal.RecordCount = 0 then
    (*if qryLogTerminal.RecordCount = 0 then
    begin
      MessageDlg('O número limite de terminais ativos foi atigindo!' +#13+#10+
                 'Entre em contato com o suporte técnico para aumentar o número de licenças',mtinformation,[mbok],0);
      Application.Terminate;
    end;*)
    // 08-02-2025 - Validação offline
    if not VerificaLicenca then
    begin
      //GravaLog('VerificaLicenca: ' + BoolToStr(VerificaLicenca));
    ...
    if ((not Dados.EhLicencaAPI) and (qryLogTerminal.RecordCount = 0)) or ((Dados.EhLicencaAPI) and (NMaxTerminais)) then
    begin
      MessageDlg('Limite de terminais ativos foi atingido!' +#13+#10+
  ...
  CdsTerminal.Close;
  qryTerminal.Params[0].Value := Dados.Getcomputer;
  CdsTerminal.Open;
end;

procedure TDados.AtualizaCidades;
begin
  CdsCidade.Open;
  qryUF.Open;
  qryUF.First;
  ...
  begin
    If qryUFUF.Value <> 'DF' then
      ACBrIBGE1.BuscarPorUF(qryUFUF.Value);
    qryUF.Next;
  end;
  qryUF.Close;
  CdsCidade.Close;
...
procedure TDados.AtualizarSistemaFTP;
var
  autoUpdate : TAutoUpdate;
begin
  autoUpdate := TAutoUpdate.Create(Self);
  try
    autoUpdate.Username := 'pdvkawwhite';

    // 21-12-2023 (SMF) - Manter a compatibilidade do login FTP com versões antigas
    if (Dados.GetBuildInfo(Application.ExeName) = '4.26.4.0') or
       (Dados.GetBuildInfo(Application.ExeName) = '4.26.5.0') or
       (Dados.GetBuildInfo(Application.ExeName) = '4.26.6.0') or
       (Dados.GetBuildInfo(Application.ExeName) = '4.26.7.0') or
       (Dados.GetBuildInfo(Application.ExeName) = '4.26.8.0') or
       (Dados.GetBuildInfo(Application.ExeName) = '4.26.9.0') or
       (Dados.GetBuildInfo(Application.ExeName) = '4.26.10.0') or
       (Dados.GetBuildInfo(Application.ExeName) = '4.26.11.0') or 
	     (Dados.GetBuildInfo(Application.ExeName) = '4.26.12.0') or
       (Dados.GetBuildInfo(Application.ExeName) = '4.26.13.0') then
    begin
      autoUpdate.Password := 'WTgrA!F3wP';
      autoUpdate.Host := 'pdvkawwhite.com';
    end
    else begin // Versão antiga
      autoUpdate.Password := 'WTFrA*F3wt';
      autoUpdate.Host := 'pdvkawwhite.com.br';
    end;

    autoUpdate.Port := 21;
    autoUpdate.Execute(GetBuildInfo(Application.ExeName));
  finally
    autoUpdate.Free;
  end;
end;
...
begin
  Dados.qryExecute.Close;
  Dados.qryExecute.sql.Text := 'UPDATE VENDAS_TERMINAIS SET EMPRESA_ATIVA=:EMPRESA WHERE NOME=:NOME';
...
begin
  ...
  qryNumeroBoleto.sql.Text := 'select coalesce(max(nboleto),0) as numero from creceber where tipo=''B'' ';
  qryNumeroBoleto.Open;
  vNossoNumero := qryNumeroBoleto.Fields[0].AsInteger;
  if vNossoNumero = 0 then
  begin
    qryNumeroBoleto.Close;
    qryNumeroBoleto.sql.Text := 'select coalesce(numero_boleto,0) from cbr_config';
    qryNumeroBoleto.Open;
...
begin
  Dados.qryExecute.Close;
  Dados.qryExecute.sql.Text := 'select nboleto from creceber where codigo=:codigo';
...
procedure TDados.ValidaChave(ContraSenha: String;var datavalidade,versao:string);
begin
  if Pos('-',contrasenha) = 9 then
  begin
    datavalidade := copy(contrasenha,1,Pos('-',contrasenha)-1);
    contrasenha  := Copy(contrasenha,Pos('-',contrasenha)+1,length(contrasenha));
    if Pos('-',contrasenha) = 7 then
    begin
      contrasenha  := Copy(contrasenha,Pos('-',contrasenha)+1,length(contrasenha));
      versao       := MudaChave(contrasenha);
      if Pos('-',contrasenha) <> 0 then
      begin
        GravaLog('Erro código 1101');
        raise Exception.Create('Erro código 1101!'+#13+#10+'Entre em contato com o suporte técnico!');
      end;
    end;
  end;
end;

function TDados.ValidaChaveAtiva: Boolean;
var
  errcode: DWORD;
  cnpj, Serial, ContraChave, Server, datavalidade, macChave:String;
begin
  Serial      := Dados.Crypt('D',Dados.CdsLicencaAtivaCHAVE.AsString);
  ContraChave := Dados.Crypt('D',Dados.CdsLicencaAtivaCONTRACHAVE.AsString);
  Dados.ValidaChave(contraChave,datavalidade,versao);
  Try
    Dados.ValidaDataValidade(datavalidade);
    Data_Validade := datavalidade;
    Result := True;
    if Date > StrToDate(datavalidade)   then
    begin
//        MessageDlg('Erro 2101' + #13 + 'Sistema expirado, entre com a nova chave de ativação',mtInformation,[mbok],0);
      Result := False;
      Exit;
    end;
  Except
    Self.Data_Validade := '';
    Result := False;
//    MessageDlg('Erro 1103' + #13 + 'Sistema expirado, entre com a nova chave de ativação',mtInformation,[mbok],0);
  End;
  // Retorna o IP do Servidor do banco de dados
  Dados.ServidorBD(Server);
  // pega o mac do servidor de banco de dados
  Mac  := Dados.GetMacAddr(Server,errcode);
  MacChave := Dados.MudaChave(Copy(serial,6,2)) + '-' + Dados.MudaChave(Copy(serial,8,2)) + '-' +
              Dados.MudaChave(Copy(serial,11,2)) + '-' + Dados.MudaChave(Copy(serial,13,2)) + '-' +
              Dados.MudaChave(Copy(serial,1,2)) + '-' + Dados.MudaChave(Copy(serial,3,2));
  if Mac <> '00-00-00-00-00-00' then // 00-00 significa sem conexão com a rede
    if ((Server = 'localhost') or (Server = '127.0.0.1')) then
      if Mac <> MacChave then // compara o mac da chave com o servidor de banco de dados
      begin
        Result := False;
    //     MessageDlg('Erro 2102' + #13 + 'Entre com a nova chave de ativação',mtInformation,[mbok],0);
        exit;
      end;
  Cnpj := Dados.MudaChave(copy(serial,16,2)) + Dados.MudaChave(copy(serial,18,2)) + Dados.MudaChave(copy(serial,21,4));
  if cnpj <> copy(dados.qryEmpresaCNPJ.AsString,1,8) then
  begin
    Result := False;
//      MessageDlg('Erro 2103' + #13 + 'Entre com a nova chave de ativação',mtInformation,[mbok],0);
    exit;
  end;

  try
    Dados.ValidaVerificador(Serial,ContraChave);
    Result := True;
  except
    Result := False;
//      MessageDlg('Erro 1104' + #13 + 'Entre com a nova chave de ativação',mtInformation,[mbok],0);
    exit;
  end;
  try
    if trim(Versao) <> '' then
    begin
      // 16-12-2024 - Comentado para validação API plano licença (Pagar.me)
	    if not Dados.EhLicencaAPI then
        NTerminais  := Dados.ValidaVersao(versao);
      self.versao := versao;
      Result      := True;
    end
    Else
  ...
  Except
    Result := False;
//      MessageDlg('Erro 1106' + #13 + 'Entre com a nova chave de ativação',mtInformation,[mbok],0);
  End;
end;

procedure TDados.ValidaDataValidade(var data: string);
var
  datavalidade: string;
begin
  try
    datavalidade := copy(MudaChave(data), 5, 2) + '/' +
                    copy(MudaChave(data), 1, 2) + '/' +
                    copy(MudaChave(data), 7, 2) +
                    copy(MudaChave(data), 3, 2);

    // 08-01-2024 - Erro ao converter data
    if StrToDateDef(datavalidade, 0) > 0 then
      data := datavalidade;
  except
    on E: Exception do
    begin
      GravaLog('Erro código 1103: ' + E.Message);
      raise Exception.Create('Erro código 1103!'+#13+#10+'Entre em contato com o suporte técnico');
    end;
  end;
end;

procedure TDados.ValidaVerificador(Serial, ContraSenha: string);
begin
  if (copy(ContraSenha,10,1) <> copy(Serial,1,1)) and
     (copy(ContraSenha,11,1) <> copy(Serial,6,1)) and
     (copy(ContraSenha,12,1) <> copy(Serial,11,1)) and
     (copy(ContraSenha,13,1) <> copy(Serial,16,1)) and
     (copy(ContraSenha,14,1) <> copy(Serial,21,1)) and
     (copy(ContraSenha,15,1) <> copy(Serial,26,1)) then
  begin
    GravaLog('Erro código 1104');
    raise Exception.Create('Erro código 1104!'+#13+#10+'Entre em contato com o suporte técnico');
  end;
end;

function TDados.ValidaVersao(versao: string): Integer;
begin
  // Retorna o número de terminais que podem se conectar
  // FREE - PREMIUM - FISCAL - GOLD
  if (versao <> ('RFRE')) and (versao <> ('RPRE')) and (versao <> ('RFIS')) and (versao <> ('RPRS')) then
    raise Exception.Create('Erro código 1106!'+#13+#10+'Entre em contato com o suporte técnico')
  else
  begin
    if (versao = 'RFRE') or (versao = 'RPRE') then
      Result := 1
    else begin
      // 23-01-2024 - Aumentar computadores em rede de 3 para 7 plano fiscal
      // 18-12-2024 - Comentado para validação pela API de licenças (Pagar.me)
      (*if (versao = 'RPRS') then
        Result := 3
      else
      if (versao = 'RFIS') then
...
procedure TDados.VerificaDataTrial;
var
  data_download: string;
begin
  data_download := qryParametroDATA_D.Value;
  data_download := MudaChave(data_download);
  data_download := copy(data_download,1,2) + '/' + copy(data_download,3,2) + '/' + copy(data_download,5,4);
  DataTrial := StrToDate(data_download);
end;

(*function TDados.WinExecAndWait32(Path: PChar; Visibility: Word; Timeout: DWORD): integer;
var
  WaitResult : integer;
  StartupInfo: TStartupInfo;
  ProcessInfo: TProcessInformation;
...
procedure TDados.ACBrIBGE1BuscaEfetuada(Sender: TObject);
var
  i: integer;
begin
  try
    for i := 1 to ACBrIBGE1.ListaCidades.Count do
    begin
      qryBuscaCidade.Params[0].Value := ACBrIBGE1.Cidades[1].CodMunicipio;
      qryBuscaCidade.Open;
      if qryBuscaCidade.RecordCount = 0 then
      begin
        CdsCidade.Insert;
        CdsCidadeCODIGO.Value    := ACBrIBGE1.Cidades[i].CodMunicipio;
        CdsCidadeDESCRICAO.Value := ACBrIBGE1.Cidades[i].Municipio;
        CdsCidadeCODUF.Value     := ACBrIBGE1.Cidades[i].CodUF;
        CdsCidadeUF.Value        := ACBrIBGE1.Cidades[i].UF;
        CdsCidade.Post;
    ...
    on E: Exception do
    begin
      GravaLog('Erro -139:  Erro ao consultar UF ' + qryUFUF.Value + '  ' + E.Message);
      //ShowMessage('Erro ao consulta UF ' + qryUFUF.Value);
      MessageDlg('Erro ao consultar UF ' + qryUFUF.Value,TMsgDlgType.mtError,[mbok],0);
    end;
  end;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      Dados.qryConsulta.Close;
      Dados.qryConsulta.sql.Clear;
      Dados.qryConsulta.sql.Add('select ci.fk_produto as codigo, pro.descricao from compra_itens ci');
      Dados.qryConsulta.sql.Add('left join produto pro on pro.codigo = Ci.FK_PRODUTO');
      ...
      begin
        Dados.qryUpdate.Close;
        Dados.qryUpdate.sql.Text := 'update COMPRA_ITENS set descricao=:nome where fk_produto=:codigo';
        Dados.qryUpdate.Params[0].Value := Dados.qryConsulta.FieldByName('descricao').AsString;
        Dados.qryUpdate.Params[1].Value := Dados.qryConsulta.FieldByName('codigo').AsInteger;
        Dados.qryUpdate.execsql;
        //Dados.Conexao.CommitRetaining;
        Conexao.Commit;
        Dados.qryConsulta.Next;
    ...
    begin
      ...
      Dados.qryConsulta.Close;
      Dados.qryConsulta.sql.Clear;
      Dados.qryConsulta.sql.Add('select co.codigo, pes.razao from ORCAMENTO co');
      Dados.qryConsulta.sql.Add('left join pessoa pes on pes.codigo = co.fk_cliente');
      ...
      begin
        Dados.qryUpdate.Close;
        Dados.qryUpdate.sql.Text := 'update orcamento set cliente=:nome where codigo=:codigo';
        Dados.qryUpdate.Params[0].AsString := Dados.qryConsulta.FieldByName('razao').AsString;
        Dados.qryUpdate.Params[1].AsInteger := Dados.qryConsulta.FieldByName('codigo').AsInteger;
        Dados.qryUpdate.execsql;
        //Dados.Conexao.CommitRetaining;
        Conexao.Commit;
        Dados.qryConsulta.Next;
      ...
      Dados.qryConsulta.Close;
      Dados.qryConsulta.sql.Clear;
      Dados.qryConsulta.sql.Add('select oi.fk_produto as codigo, pro.descricao from orcamento_item oi');
      Dados.qryConsulta.sql.Add('left join produto pro on pro.codigo = oi.FK_PRODUTO');
      ...
      begin
        Dados.qryUpdate.Close;
        Dados.qryUpdate.sql.Text := 'update orcamento_item set descricao=:nome where fk_produto=:codigo';
        Dados.qryUpdate.Params[0].Value := Dados.qryConsulta.FieldByName('descricao').AsString;
        Dados.qryUpdate.Params[1].Value := Dados.qryConsulta.FieldByName('codigo').AsInteger;
        Dados.qryUpdate.execsql;
        //Dados.Conexao.CommitRetaining;
    ...
    begin
      ...
      Dados.qryConsulta.Close;
      Dados.qryConsulta.sql.Clear;
      Dados.qryConsulta.sql.Add('select os.codigo, pes.razao from OS_MASTER os');
      Dados.qryConsulta.sql.Add('left join pessoa pes on pes.codigo = os.fk_cliente');
      ...
      begin
        Dados.qryUpdate.Close;
        Dados.qryUpdate.sql.Text := 'update OS_MASTER set nome=:nome where codigo=:codigo';
        Dados.qryUpdate.Params[0].Value := Dados.qryConsulta.FieldByName('razao').AsString;
        Dados.qryUpdate.Params[1].Value := Dados.qryConsulta.FieldByName('codigo').AsInteger;
        Dados.qryUpdate.execsql;
        //Dados.Conexao.CommitRetaining;
        Conexao.Commit;
      ...
      Dados.qryConsulta.Close;
      Dados.qryConsulta.sql.Clear;
      Dados.qryConsulta.sql.Add('select od.fk_produto as codigo, pro.descricao from OS_DETALHE od');
      Dados.qryConsulta.sql.Add('left join produto pro on pro.codigo = od.FK_PRODUTO');
      ...
      begin
        Dados.qryUpdate.Close;
        Dados.qryUpdate.sql.Text := 'update OS_DETALHE set discriminacao=:nome where fk_produto=:codigo';
        Dados.qryUpdate.Params[0].Value := Dados.qryConsulta.FieldByName('descricao').AsString;
        Dados.qryUpdate.Params[1].Value := Dados.qryConsulta.FieldByName('codigo').AsInteger;
        Dados.qryUpdate.execsql;
        //Dados.Conexao.CommitRetaining;
    ...
    begin
      ...
      Dados.qryConsulta.Close;
      Dados.qryConsulta.sql.Clear;
      Dados.qryConsulta.sql.Add('select NM.codigo, pes.razao from NFE_MASTER NM');
      Dados.qryConsulta.sql.Add('left join pessoa pes on pes.codigo = NM.id_cliente');
      ...
      begin
        Dados.qryUpdate.Close;
        Dados.qryUpdate.sql.Text := 'update NFE_MASTER set nome=:nome where codigo=:codigo';
        Dados.qryUpdate.Params[0].Value := Dados.qryConsulta.FieldByName('razao').AsString;
        Dados.qryUpdate.Params[1].Value := Dados.qryConsulta.FieldByName('codigo').AsInteger;
        Dados.qryUpdate.execsql;
        //Dados.Conexao.CommitRetaining;
      ...
      Dados.qryConsulta.Close;
      Dados.qryConsulta.sql.Clear;
      Dados.qryConsulta.sql.Add('select nd.ID_produto as codigo, pro.descricao from NFE_DETALHE nd');
      Dados.qryConsulta.sql.Add('left join produto pro on pro.codigo = nd.ID_PRODUTO');
      ...
      begin
        Dados.qryUpdate.Close;
        Dados.qryUpdate.sql.Text := 'update NFE_DETALHE set descricao=:nome where ID_produto=:codigo';
        Dados.qryUpdate.Params[0].Value := Dados.qryConsulta.FieldByName('descricao').AsString;
        Dados.qryUpdate.Params[1].Value := Dados.qryConsulta.FieldByName('codigo').AsInteger;
        Dados.qryUpdate.execsql;
        //Dados.Conexao.CommitRetaining;
...
//  Celular := '55' + DDD + trim(copy(TiraPontos(fone), 4, 10)) + '@c.us';
  ...
  Dados.qryMensagemZapCODIGO.Value := Dados.Numerador('MENSAGEM_ZAP', 'CODIGO', 'N', '', '');
...
procedure TDados.AtualizaDataBase;
var
  v_version, v_update, v_result_update : String;
  v_atualizar: boolean;
begin
  Try
    // Atualiza banco de dados via qryUpdateDatabase
    v_atualizar := false;
    v_result_update := '';
    qryCheckVersion.Open;
    v_version := GetBuildInfo(Application.ExeName);
    v_version := StringReplace(v_version,'.','',[rfReplaceAll]);

    // Atualiza via arquivo txt
    if FileExists(ExtractFilePath(Application.ExeName) + 'scriptUBD.txt') then
    begin
      qryUpdateDatabase.SQL.LoadFromFile(ExtractFilePath(Application.ExeName) + 'scriptUBD.txt');
      DeleteFile(pchar(ExtractFilePath(Application.ExeName) + 'scriptUBD.txt'));
      v_atualizar := True;
    end
    else
    begin
      qryParametro.Open;
      if StrtoInt(v_version) > qryParametroVERSAO.Value then
        v_atualizar := True;
    end;

    if v_atualizar then
    begin
      v_update := qryUpdateDatabase.SQL.Text;

      while length(trim(v_update)) > 0 do
      begin
        qryUpdateDatabase.SQL.Clear;
        qryUpdateDatabase.SQL.Text := copy(v_update,1,pos(';',v_update));

        v_update := Copy(v_update,length(qryUpdateDatabase.SQL.Text)+1,length(v_update));
        try
          if (trim(v_update)<>'') or ((trim(v_update)='') and (length(trim(qryUpdateDatabase.SQL.Text))>0)) then
          begin
            qryUpdateDatabase.ExecSQL;
            v_result_update := v_result_update + qryUpdateDatabase.SQL.Text + ' - atualizado';
          end;
        except
          v_result_update := v_result_update + qryUpdateDatabase.SQL.Text + ' - não atualizado';
        end;
      end;

      qryUpdateDatabase.sql.Clear;
      qryUpdateDatabase.sql.Text := v_result_update;
      qryUpdateDatabase.SQL.SaveToFile(ExtractFilePath(Application.ExeName) + 'updateDatabase.log');

      qryCheckVersion.Edit;
      qryCheckVersionVERSAO.Value := strtoint(v_version);
      qryCheckVersion.Post;
      qryCheckVersion.Close;
    ...
    on E: Exception do
    begin
      GravaLog('Erro -21: ' + E.Message);
      MessageDlg('Não foi possível atualizar o banco de dados com a última versão!' + #13 + 'Entre em contato com o suporte técnico', mtWarning, [mbok],0);
    end;
  end;
end;
...
var
  sArq, sParametros: String;
  iArq: TIniFile;
  i: Integer;
  nTentativas: Word;
  data_download: String;
  MyProcList: TStringList;
  FirebirdAtivo, bOK: Boolean;
  S: TSearchRec;
  iRetorno: Cardinal;
begin
  try
    ...
    // 23-12-2023 (SMF) - Carregar tradução pt-BR do gerador de relatórios FastReport
    frxResources.LoadFromFile(ExtractFilePath(ParamStr(0))+'Relatorio\frxrcClass.xml');
    frxResources.LoadFromFile(ExtractFilePath(ParamStr(0))+'Relatorio\frxrcDesgn.xml');
    frxResources.LoadFromFile(ExtractFilePath(ParamStr(0))+'Relatorio\frxrcExports.xml');
    frxResources.LoadFromFile(ExtractFilePath(ParamStr(0))+'Relatorio\frxrcInsp.xml');

    // 23-01-2024 (SMF) - Tradução pt-BR das mensagens de diálogo
    ...
    // 23-12-2023 (SMF) - Validar se o arquivo de configuração existe
    sArq := ExtractFilePath(Application.ExeName) + 'Banco.ini';
    if not FileExists(sArq) then
      MessageDlg('Não foi possível encontrar o arquivo Banco.ini em seu computador!' + #13+#10 + 'Entre em contato com o suporte técnico', mtError,[mbok],0)
    else
    ...
    // 23-12-2023 (- Validar client dll do Firebird se existe na pasta Gestor
    if not FileExists(FBDriver.VendorLib) then
    begin
      MessageDlg('Não foi possível encontrar o arquivo fbclient.dll em seu computador.' + #13+#10 + 'Entre em contato com o suporte técnico', mtError,[mbok],0);
    end
    else begin
      if GetFileVersion(FBDriver.VendorLib) <> '2.5.8.27089' then
        MessageDlg('Versão do arquivo fbclient.dll inválida.' + #13+#10 + 'Entre em contato com o suporte técnico', mtError,[mbok],0);
    end;

    GetOpenProcess(MyProcList);

    while nTentativas <= 12 do
    begin
      for i := 0 to MyProcList.Count -1 do
      begin
        if (CompareText(MyProcList.Strings[i], 'fbserver.exe') = 0) or (CompareText(MyProcList.Strings[i], 'fb_inet_server.exe') = 0) then
        begin
          FirebirdAtivo := True;
          break;
        end;
    ...
    begin
      ...
      // 23-12-2023 (SMF) - Verificar instalação do Firebird Server
      if not FirebirdAtivo then
      begin
        sArq := ExtractFilePath(ParamStr(0)) + 'Utils\Firebird-2.5.8.27089_0_Win32.exe';
        if FileExists(sArq) then
        begin
          // todo: Criar form de aguarde da instalação
          //MessageDlg('Firebird não está instalado em seu computador.' + #13#10 + 'Entre em contato com o suporte técnico!', TMsgDlgType.mtWarning,[mbok],0);
          //MessageDlg('Firebird não está instalado em seu computador.' + #13#10 + 'Por favor, aguarde a instalação finalizar!', TMsgDlgType.mtInformation,[mbok],0);

          // todo: Verificar se é PC servidor do Firebird

          sParametros := '/VERYSILENT';

          if not RunAsAdmin(Application.Handle, sArq, sParametros, false) then
            MessageDlg('Não foi possível instalar o Firebird em seu computador.' + #13+#10 + 'Entre em contato com o suporte técnico', TMsgDlgType.mtWarning,[mbok],0);
          //else
          //  MessageDlg('Firebird instalado com sucesso!', TMsgDlgType.mtInformation,[mbok],0);
        end
        else
          MessageDlg('Não foi possível encontrar o instalador do Firebird em seu computador!.' + #13 +#10+ 'Entre em contato com o suporte técnico', mtError,[mbok],0);
      end;
    end;

    if not (FileExists('C:\Program Files (x86)\Firebird\Firebird_2_5\bin\fbserver.exe')) and
           (FileExists('C:\Program Files (x86)\Firebird\Firebird_2_5\bin\fb_inet_server.exe')) and
           (FileExists('C:\Program Files\Firebird\Firebird_2_5\bin\fbserver.exe')) and
           (FileExists('C:\Program Files\Firebird\Firebird_2_5\bin\fb_inet_server.exe')) then
    begin
      MessageDlg('Não foi possível encontrar o Firebird instalado em seu computador.' + #13+#10+ 'Entre em contato com o suporte técnico', mtError,[mbok],0);
    end;
    ...
    try
      ...
      on E: Exception do
      begin
        GravaLog('Erro -18: ' +E.Message);
        MessageDlg('Não foi possível conectar com a base de dados!' + sLineBreak +
          //'Verifique e pasta C:\Gestor\Dados\DADOS.FDB' +
          {sLineBreak + ' Se não encontrar esse arquivo restaure um backup. ' + sLineBreak +} 'Entre em contato com o suporte técnico.', mtError,[mbok],0);

        Dados.vFechaPrograma := true;

        if MessageDlg('Deseja alterar as configurações do sistema para acessar um Servidor em rede?', mtConfirmation, [mbyes, mbno],0) = 6 Then
        begin
          FrmConfigDatabase := TFrmConfigDatabase.Create(nil);
          try
            FrmConfigDatabase.ShowModal;
          finally
            FrmConfigDatabase.Free;
          end;
        end;

        Application.Terminate;
        Application.ProcessMessages; // 23-02-2025 - Não está finalizando o sistema
      end;
    end;
  ...
  try
    CdsLicencaAtiva.Open;
  except
    on E: Exception do
    begin
      GravaLog('Erro -19: '+E.Message);

      if pos('Unable to complete network', E.Message)>0 then
        MessageDlg('Não foi possível concluir a solicitação de rede para o computador!'+#13+#10+'Entre em contato com o suporte técnico.', TMsgDlgType.mtWarning,[mbok],0)
      else
        MessageDlg('Sistema requer atualização do banco de dados!'+#13+#10+'Erro -19: '+E.Message+#13+#10+'Entre em contato com o suporte técnico.', TMsgDlgType.mtWarning,[mbok],0);
    end;
  end;
  ...
  try
    ...
    if CdsParametroDATA_D.IsNull then // Verifica se é o primeiro acesso após o download
    begin
      // 03-01-2024 (SMF) - Alterado de 30 para 16 dias gratuitos
      //data_download := DateToStr(date+30);
      data_download := DateToStr(date+16);
      data_download := copy(data_download,1,2) + copy(data_download,4,2) + copy(data_download,7,4);

      CdsParametro.Edit;
      CdsParametroDATA_D.Value := MudaChave(data_download);
      CdsParametro.Post;
    ...
    on E: Exception do
    begin
      GravaLog('Erro -20: ' +E.Message);
    end;
  end;

  // Atualizada a tabela cidades tendo como base a TABELA do IBGE
  // 20-04-2024 - Criar menu para atualizar cidades
  (*try
    dados.AtualizaCidades;
  except
    on E: Exception do
    begin
      GravaLog('Erro -17: ' +E.Message);
      MessageDlg('Não foi possível atualizar a base de dados com a tabela do IBGE!' + #13 + 'Entre em contato com o suporte técnico.', mtWarning, [mbok],0);
    end;
  end;*)
...
begin
  Dados.cdsTerminal.locate('NOME', Dados.Getcomputer, []);
end;

procedure TDados.LimpaTEF(NSU: String);
begin
  Dados.qryExecute.Close;
  Dados.qryExecute.sql.Text := 'UPDATE VENDAS_FPG SET NSU=null, INDICE=null, REDE=null, REDECNPJ=null, FEZ_TEF=''N'' WHERE NSU=:ID';
...
begin
  Dados.qryExecute.Close;
  Dados.qryExecute.sql.Text := 'SELECT REMESSA_ARQUIVO, ID_CBR_REMESSA_UUID FROM CRECEBER WHERE FK_VENDA=:VD';
  Dados.qryExecute.Params[0].Value := codigo;
  Dados.qryExecute.Open;
  //Dados.Conexao.CommitRetaining;
  Conexao.Commit;
  DeletaRemessa(Dados.qryExecute.FieldByName('REMESSA_ARQUIVO').AsString, Dados.qryExecute.FieldByName('ID_CBR_REMESSA_UUID').AsString);
  Dados.qryExecute.Close;
...
begin
  ...
  begin
    // adiciona estoque
    Dados.qryExecute.Close;
    Dados.qryExecute.sql.Text := 'update produto set qtd_atual = qtd_atual + :qtd, e_medio = e_medio + :qtd1 where codigo=:cod';
...
begin
  ...
  begin
    ...
    Dados.qryTransfCODIGO.Value := Dados.Numerador('CAIXA', 'CODIGO', 'N', '', '');
    ...
    Dados.qryTransfHISTORICO.Value := 'TRANSFERENCIA P/ CAIXA Nº' + Dados.qryCaixaFKCONTA.AsString;
    ...
    if Dados.qryTransfSAIDA.Value > 0 then
      Dados.qryTransfFKPLANO.Value := Dados.qryEmpresaID_PLANO_TRANSFERENCIA_D.Value;
    if Dados.qryTransfENTRADA.Value > 0 then
      Dados.qryTransfFKPLANO.Value := Dados.qryEmpresaID_PLANO_TRANSFERENCIA_C.Value;
...
begin
  if Dados.qryCC.State = dsInsert then
    Dados.qryCCCODIGO.Value := Dados.Numerador('PESSOA_CONTA', 'CODIGO','N', '', '');
end;
...
procedure TDados.qryCompraTTOTALGetText(Sender: TField; var Text: string;
  DisplayText: Boolean);
begin
...
begin
  if Length(trim(qryConfigCODIGO_ATIVACAO.AsString)) < 8 then
    raise Exception.Create('Tamanho do código de ativação não pode ter menos de oito caracteres!');
end;
...
begin
  ...
  // 12-03-2024
  Dados.qryConfigPASTA_CFE_VENDA.Value := ExtractFilePath(Application.ExeName) + 'CFe\Venda';
  Dados.qryConfigPASTA_CFE_CANCELAMENTO.Value := ExtractFilePath(Application.ExeName) + 'CFe\Cancelamento';
  Dados.qryConfigPASTA_CFE_ENVIO.Value := ExtractFilePath(Application.ExeName) + 'CFe\Envio';
  Dados.qryConfigPASTA_CFE_PDF.Value := ExtractFilePath(Application.ExeName) + 'CFe\PDF';
  Dados.qryConfigPASTA_CFE_SCHEMA.Value := ExtractFilePath(Application.ExeName) + 'CFe\Schemas';
...
procedure TDados.qryEmpresaCNPJGetText(Sender: TField; var Text: string;
  DisplayText: Boolean);
begin
  // 07-07-2025 - Formatar CNPJ da empresa plano fiscal
  if (versao = 'RFIS') and ((not VarIsNull(Sender.Value)) and (Length(Sender.Value)>0)) then
  begin
    if Length(Sender.Value)=14 then
      Text := FormatMaskText('99.999.999/9999-99;0', Sender.Value);
  end;
end;
...
begin
  ...
  qryEmpresaCRT.Value := 1; // Simples Nacional
  qryEmpresaID_PLANO_VENDA.Value := 2;
  qryEmpresaOBSFISCO.Value :=   'I - "DOCUMENTO EMITIDO POR ME OU EPP OPTANTE PELO SIMPLES NACIONAL"; e II - "NÃO GERA DIREITO A CRÉDITO FISCAL DE ISS E DE IPI".';
  ...
  qryEmpresaBLOQUEAR_PRECO.Value := 'S'; // 12-11-2024 - Padrão bloquear sim
  ...
  qryEmpresaLANCAR_CARTAO_CR.Value := 'S';
...
begin
  Dados.qryEtiquetaCODIGO.Value := Dados.Numerador('ETIQUETAS', 'CODIGO', 'N', '', '');
end;
...
begin
  Dados.qryEtq_CamposCODIGO.Value := Dados.Numerador('ETIQUETA_CAMPOS', 'CODIGO', 'N', '', '');
...
begin
  try
    ...
    qryAjustaPrecoPR_CUSTO2.AsFloat := SimpleRoundTo(qryAjustaPrecoPR_CUSTO.AsFloat + (qryAjustaPrecoPR_CUSTO.AsFloat * qryAjustaPrecoPERC_CUSTO.AsFloat/100), -2);

    if venda>0 then
      qryAjustaPrecoPR_VENDA.AsFloat := SimpleRoundTo(venda, -2);

    if qryAjustaPrecoPR_VENDA.AsFloat>0 then
      qryAjustaPrecoMARGEM.AsFloat := 100-((qryAjustaPrecoPR_CUSTO2.AsFloat * 100)/qryAjustaPrecoPR_VENDA.AsFloat);
...
begin
  ...
  begin
    ...
    qryMesasVIRTUAL_MESA.Value := 'MESA ' + FormatFloat('000', qryMesasCODIGO.AsInteger);
  end;
end;
...
begin
  if qryMotorista.State = dsInsert then
    qryMotoristaCODIGO.AsInteger := Dados.Numerador('TRANSPORTADORA_MOTORISTA', 'CODIGO', 'N', '', '');
end;
...
function TDados.MudaChave(Chave: string): string;
var
  tamanho, i: integer;
  nserial: String;
  vSerial: String;
...
begin
  try
    ...
    Dados.qryAtualiza.sql.Text := 'update EMPRESA set data_validade=:DATA, CSENHA=:CSENHA WHERE CODIGO=:COD';
    Dados.qryAtualiza.ParamByName('DATA').AsString := Crypt('C', FormatDateTime('dd/mm/yyyy', Data));
    if Bloqueado = 'T' then
...
begin
  if Dados.qryTransp.State = dsInsert then
    Dados.qryTranspCODIGO.Value := Dados.Numerador('TRANSPORTADORA', 'CODIGO', 'N', '', '');
end;

procedure TDados.qryVeiculos_ReboqueNewRecord(DataSet: TDataSet);
begin
  Dados.qryVeiculos_ReboqueCODIGO.Value := Dados.Numerador('VEICULOS_REBOQUE', 'CODIGO', 'N', '', '');
...
begin
  Dados.qryExecute.Close;
  Dados.qryExecute.sql.Text := 'update creceber set flag=''N'' where fkcliente=:id';
  Dados.qryExecute.Params[0].Value := codigo;
  Dados.qryExecute.execsql;
  //Dados.Conexao.CommitRetaining;
  Conexao.Commit;
...
begin
  Dados.qryExecute.Close;
  Dados.qryExecute.sql.Text := 'update cpagar set flag=''N'' where FKFORNECE=:id';
  Dados.qryExecute.Params[0].Value := codigo;
  Dados.qryExecute.execsql;
  //Dados.Conexao.CommitRetaining;
  Conexao.Commit;
...
begin
  ...
  Dados.qryExecute.sql.Add(' :TIPO_MOVIMENTO,');
  Dados.qryExecute.sql.Add(' :FPG)');
  Dados.qryExecute.ParamByName('CODIGO').Value :=  Dados.Numerador('CAIXA', 'CODIGO', 'N', '', '');
