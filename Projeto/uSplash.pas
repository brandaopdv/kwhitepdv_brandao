...
begin
  ...
  begin
    Image1.Picture.LoadFromFile(dados.qryParametro.FieldByName('TELA_ABERTURA').AsString);
...
begin
  ...
  try
    ...
    begin
      ...
      dados.qryParametro.FieldByName('TELA_ABERTURA').AsString :=  OpenPicture.FileName;
